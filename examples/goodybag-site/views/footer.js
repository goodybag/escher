define(function(require){
  ...
  , initialize: function(options){
      ...
      // Setup a limited API
      rad.subscribe(prefix + 'footer.toggle',          utils.bind(this.toggle,         this));
      rad.subscribe(prefix + 'footer.show',            utils.bind(this.show,           this));
      rad.subscribe(prefix + 'footer.hide',            utils.bind(this.hide,           this));
      rad.subscribe(prefix + 'footer.enterSlideMode',  utils.bind(this.enterSlideMode, this));
      rad.subscribe(prefix + 'footer.exitSlideMode',   utils.bind(this.exitSlideMode,  this));
